      ...
      <Box p={4}  border={'1px solid grey'} >
        ...
        <Flex alignItems="center" px={55}  >
          {booking.staff[0].isAvailable ? (
            <Text color='green.300' fontWeight={'bold'}>{`${booking.staff[0].firstName} ${booking.staff[0].lastName}`} is available</Text>
          ) : (
            <Text color='orange.300' fontWeight={'bold'}>Suitable staff member will be assigned</Text>
          )}
        </Flex>
        </Stack>
